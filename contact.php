...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	...
	<img class="menu_footer" src="images/footer.jpg" alt="" />
		<div class="banner-header">
			<!--header-->
			<div class="header pages_header">
				<div class="container-fluid">
					<nav class="navbar navbar-default pages_navbar">
						<div class="navbar-header navbar-left">
							...
							<div class="w3_navigation_pos">
								<h1><a href="index.html">FOODERZ <img class="fooderz_logo" src="images/logo.png" alt="" /></a></h1>
							</div>
						</div>
						...
						<ul class="menu cf">
							...
							<li>
								<a href="#">صبحانه ها</a>
								<ul class="submenu">
								<li><a href="#">صبحانه فرنگی</a></li>
								<li><a href="#">صبحانه سنتی ایرانی</a></li>
								</ul>
							</li>
						...
						<nav class="mobile-nav">
							<ul class="nav">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-hover="Pages" data-toggle="dropdown">صبحانه ها <b class="caret"></b></a>
									<ul class="dropdown-menu">
										<li><a href="#">ایرانی</a></li>
										<li><a href="#">فرنگی</a></li>
									</ul>
								</li>
				...
				<div class="contact-agileinfo">
					...
					<div class="col-md-7 contact-right"> 
						<!-- <form action="#" method="post" id="contactFrm"> -->
							<label id="lblname"style="color: #ff0c27"></label>
							...
							<label id="lblEmail" style="color: #ff0c27"></label>
	...
	<!-- News letter -->
		<div class="agile-form">
			<div class="container">
				...
				<p>از اطلاعیه ها و تخفیفات فودرز باخبر شو</p>
				<h4>دریافت ربات تلگرام فودرز</h4>
				</div>
				<div class="col-md-8">
					<form action="#" method="get">
					<input type="submit" value="">
						<input type="email" name="email" placeholder="شماره موبایل ..." required="">
				...
				<div class="footer-main">
					<div class="footer-top">
						...
						<div class="col-md-4 ftr-grid fg2 mid-gd">
							<h3>پشتیبانی فودرز</h3>
							<p>تماس با پشتیبانی</p>
							<p>قوانین و مقررات</p>
						</div>
						<div class="col-md-4 ftr-grid fg2">
							<h3>دریافت اپلیکیشن</h3>
							<p><img src="images/bazaar.png" alt="" width="150px" /></p>
							<p><img src="images/sibapp.png" alt="" width="140px" style="margin-right:5px;" /></p>
						</div>
					   <div class="clearfix"> </div>
					</div>
		...
		<script src="../FooderzAdmin/Js/jquery-1.10.2.js"></script>
