...
include "../../DataBase/PDO/DBconnect/DBconnect.php";
    ...
    try
    {
        ...
        $query='SELECT `cus_ID`, `fname`, `lname`, `bornDate`, `phone`, `password`, `email`, `cardNum`, `location`, `address`, `city`, `credit`, `Gift`, `favorite_restaurants`, `firstBuyCall`, `SignupDate` FROM `customers` order  by SignupDate DESC ';
